		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">mYTour Pvt. Ltd.</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span></h5>
						<h5 style="color:#000"><span class="img2"></span>pkandpal601@gmail.com<a href="#">&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;support@mytour.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Haldwani Uttarakhand.</h5>
                        <br/>
